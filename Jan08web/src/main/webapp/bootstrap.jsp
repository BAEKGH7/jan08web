...
<link rel="icon" type="image/x-icon" href="assets/faviconn.ico" />
<!-- Bootstrap icons-->
<link
...
<body id="page-top">
	...
	<section>
		...
		<div class="m-5 p-5 border border-info border-5">
		...
		<div class="container bg-info text-white">
			...
			<div class="my-2 bg-danger w-50">구역 5</div>
			<div class="my-2 bg-warning w-75">구역 6</div>
			<div class="my-2 bg-dark w-100">구역 7</div>
			<div class="my-2 bg-white w-100">구역 8</div>
		</div>
	...
	<footer class="bg-black text-center py-5">
		<div class="container px-5">
			<div class="text-white-50 small">
				<div class="mb-2">&copy; 배고파요 졸려요 2024. All Rights Reserved.</div>
